...
public class SelezionaProgettoRegistrazione extends HttpServlet {

	private static final long serialVersionUID = 13266377411471318L;

	public SelezionaProgettoRegistrazione() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			ProgettoGruppo pg = manager.scegliProgetto(nomeProj);
			request.getSession().setAttribute("progettotemp", pg);
			...
			disp = request.getRequestDispatcher("SelezionaProgettoRegistrazione.jsp");
		}
